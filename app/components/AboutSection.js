...
const AboutSection = () => {
    ...
    return (
        <div id='about' className='text-white h-[180vh] md:h-[150vh] 2xl:h-[90vh] mt-16 mb-24 md:mb-0 md:mt-0 md:my-12 '>
            <div className='md:grid md:grid-cols-2 gap-8 items-center px-4 py-8 xl:gap-16 sm:py-16 xl:px-16 '>
                ...
                <div className='mt-4 md:mt-0 text-left flex flex-col h-full'>
                    <h2 className='text-xl md:text-4xl font-bold text-white mb-4'>About Me</h2>
                    ...
                    <div className='flex flex-col md:flex-row mt-8  '>
                        ...
                        <CardButton selectCard={() => handleCardChange('experience')} active={card === 'experience'}>{" "}Experience{" "}</CardButton>
